...
const (
	...
	fileName   = "/home/knodir/devel/k8s_workshop/google_storage" // The name of the local file to upload.
	objectName = "temp-data"    // This can be changed to any valid object name.
